...
public final class ReaderBasedParser extends JsonParserBase {
  ...
  private String _parseUnusualFieldName2(int paramInt1, int paramInt2, int[] paramArrayOfint) {
    ...
    while (true) {
      ...
      paramInt1 = textBuffer.getTextOffset();
      int j = textBuffer.size();
...
/* Location:              C:\Users\walle\Downloads\boomlings-1-20 (2)\classes-dex2jar.jar!\com\flurry\org\codehaus\jackson\impl\ReaderBasedParser.class
