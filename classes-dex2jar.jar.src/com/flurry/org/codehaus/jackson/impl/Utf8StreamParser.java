...
public final class Utf8StreamParser extends JsonParserBase {
  ...
  private final JsonToken _parseFloatText(char[] paramArrayOfchar, int paramInt1, int paramInt2, boolean paramBoolean, int paramInt3) {
    ...
    //   342: aload_0
    //   343: iload #7
    //   345: ldc 'Exponent indicator not followed by a digit'
    //   347: invokevirtual reportUnexpectedNumberChar : (ILjava/lang/String;)V
    //   350: iload_2
    //   351: istore #11
    //   353: iload_3
    //   354: istore #10
    ...
    //   365: aload_0
    //   366: aload_0
    //   367: getfield _inputPtr : I
    //   370: iconst_1
    //   371: isub
    //   372: putfield _inputPtr : I
    //   375: aload_0
    //   376: getfield _textBuffer : Lcom/flurry/org/codehaus/jackson/util/TextBuffer;
    //   379: iload #11
    //   381: invokevirtual setCurrentLength : (I)V
    //   384: aload_0
    //   385: iload #4
    //   387: iload #5
    //   389: iload #8
    //   391: iload #9
    //   393: invokevirtual resetFloat : (ZIII)Lcom/flurry/org/codehaus/jackson/JsonToken;
    //   396: areturn
    //   397: aload_0
    //   398: getfield _inputBuffer : [B
    //   401: astore #12
    //   403: aload_0
    //   404: getfield _inputPtr : I
    //   407: istore #6
    //   409: aload_0
    //   410: iload #6
    //   412: iconst_1
    //   413: iadd
    //   414: putfield _inputPtr : I
    //   417: aload #12
    //   419: iload #6
    //   421: baload
    //   422: sipush #255
    ...
    //   464: if_icmplt -> 567
    //   467: aload_0
    //   468: getfield _textBuffer : Lcom/flurry/org/codehaus/jackson/util/TextBuffer;
    //   471: invokevirtual finishCurrentSegment : ()[C
    //   474: astore_1
    //   475: iconst_0
    //   476: istore_2
    //   477: iload_2
    ...
    //   495: goto -> 34
    //   498: aload_0
    //   499: getfield _inputBuffer : [B
    //   502: astore_1
    //   503: aload_0
    //   504: getfield _inputPtr : I
    //   507: istore #7
    //   509: aload_0
    //   510: iload #7
    //   512: iconst_1
    //   513: iadd
    //   514: putfield _inputPtr : I
    //   517: aload_1
    //   518: iload #7
    //   520: baload
    //   521: sipush #255
  ...
  protected JsonToken _handleApostropheValue() {
    ...
    label48: while (true) {
      ...
      i = this._inputEnd;
      int k = this._inputPtr + arrayOfChar1.length - j;
      if (k >= i)
        k = i; 
      while (true) {
  ...
  protected final Name _parseApostropheFieldName() {
    ...
    //   445: aload #6
    //   447: arraylength
    //   448: invokestatic growArrayBy : ([II)[I
    //   451: astore #7
    //   453: aload_0
    //   454: aload #7
    //   456: putfield _quadBuffer : [I
    //   459: aload #7
    //   461: iload_1
    //   462: iload_3
    //   463: iastore
    ...
    //   512: aload #6
    //   514: arraylength
    //   515: invokestatic growArrayBy : ([II)[I
    //   518: astore #7
    //   520: aload_0
    //   521: aload #7
    //   523: putfield _quadBuffer : [I
    //   526: aload #7
    //   528: iload_1
    //   529: iload #5
    //   531: iastore
  ...
  protected Name parseEscapedFieldName(int[] paramArrayOfint, int paramInt1, int paramInt2, int paramInt3, int paramInt4) {
    ...
    //   254: istore_3
    //   255: aload_0
    //   256: getfield _inputPtr : I
    //   259: aload_0
    //   260: getfield _inputEnd : I
    //   263: if_icmplt -> 280
    //   266: aload_0
    //   267: invokevirtual loadMore : ()Z
    //   270: ifne -> 280
    //   273: aload_0
    //   274: ldc_w ' in field name'
    //   277: invokevirtual _reportInvalidEOF : (Ljava/lang/String;)V
    //   280: aload_0
    //   281: getfield _inputBuffer : [B
    //   284: astore #8
    //   286: aload_0
    //   287: getfield _inputPtr : I
    //   290: istore #4
    //   292: aload_0
    //   293: iload #4
    //   295: iconst_1
    //   296: iadd
    //   297: putfield _inputPtr : I
    //   300: aload #8
    //   302: iload #4
    //   304: baload
    //   305: sipush #255
    ...
    //   311: goto -> 5
    //   314: aload_0
    //   315: invokevirtual _decodeEscaped : ()C
    //   318: istore #4
    //   320: goto -> 118
    //   323: iload #4
    //   325: bipush #12
    ...
    //   357: aload_1
    //   358: arraylength
    //   359: invokestatic growArrayBy : ([II)[I
    //   362: astore #8
    //   364: aload_0
    //   365: aload #8
    //   367: putfield _quadBuffer : [I
    //   370: aload #8
    //   372: iload_2
    //   373: iload_3
    //   374: iastore
    ...
    //   426: aload_1
    //   427: arraylength
    //   428: invokestatic growArrayBy : ([II)[I
    //   431: astore #8
    //   433: aload_0
    //   434: aload #8
    //   436: putfield _quadBuffer : [I
    //   439: aload #8
    //   441: iload_2
    //   442: iload #4
    //   444: iastore
  ...
  protected final JsonToken parseNumberText(int paramInt) {
    ...
    while (true) {
      if (this._inputPtr >= i)
        return _parserNumber2(arrayOfChar, paramInt, bool, j); 
      byte[] arrayOfByte = this._inputBuffer;
      k = this._inputPtr;
      this._inputPtr = k + 1;
      ...
      if (k < 48 || k > 57) {
        if (k == 46 || k == 101 || k == 69)
          return _parseFloatText(arrayOfChar, paramInt, k, bool, j); 
      } else {
        j++;
        arrayOfChar[paramInt] = (char)k;
        paramInt++;
        continue;
      } 
      this._inputPtr--;
...
/* Location:              C:\Users\walle\Downloads\boomlings-1-20 (2)\classes-dex2jar.jar!\com\flurry\org\codehaus\jackson\impl\Utf8StreamParser.class
