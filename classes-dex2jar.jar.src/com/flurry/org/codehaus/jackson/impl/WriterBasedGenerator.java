...
public final class WriterBasedGenerator extends JsonGeneratorBase {
  ...
  private void _writeString2(int paramInt) {
    ...
    int[] arrayOfInt = this._outputEscapes;
    int i = arrayOfInt.length;
    label16: while (this._outputTail < paramInt) {
      int j;
      do {
  ...
  private void writeRawLong(String paramString) {
    ...
    _flushBuffer();
    int j;
    for (j = paramString.length() - i; j > this._outputEnd; j -= k) {
...
/* Location:              C:\Users\walle\Downloads\boomlings-1-20 (2)\classes-dex2jar.jar!\com\flurry\org\codehaus\jackson\impl\WriterBasedGenerator.class
