...
public class BeanDeserializer extends StdDeserializer implements ResolvableDeserializer {
  ...
  protected JsonDeserializer _findSubclassDeserializer(DeserializationContext paramDeserializationContext, Object paramObject, TokenBuffer paramTokenBuffer) {
    ...
    //   123: astore #4
    //   125: new com/flurry/org/codehaus/jackson/map/type/ClassKey
    //   128: astore_3
    //   129: aload_3
    //   130: aload_2
    //   131: invokevirtual getClass : ()Ljava/lang/Class;
    //   134: invokespecial <init> : (Ljava/lang/Class;)V
    //   137: aload #4
    //   139: aload_3
    //   140: aload_1
  ...
  protected SettableBeanProperty _resolveUnwrappedProperty(DeserializationConfig paramDeserializationConfig, SettableBeanProperty paramSettableBeanProperty) {
    ...
    if (annotatedMember != null && paramDeserializationConfig.getAnnotationIntrospector().shouldUnwrapProperty(annotatedMember) == Boolean.TRUE) {
      JsonDeserializer jsonDeserializer2 = paramSettableBeanProperty.getValueDeserializer();
      JsonDeserializer jsonDeserializer1 = jsonDeserializer2.unwrappingDeserializer();
      if (jsonDeserializer1 != jsonDeserializer2 && jsonDeserializer1 != null)
        return paramSettableBeanProperty.withValueDeserializer(jsonDeserializer1); 
    } 
    return null;
  }
      ...
      if (jsonToken == JsonToken.FIELD_NAME) {
        ...
        if (settableBeanProperty != null) {
          ...
          if (propertyValueBuffer.assignParameter(settableBeanProperty.getPropertyIndex(), object1)) {
            ...
            return externalTypeHandler.complete(paramJsonParser, paramDeserializationContext, object1);
          } 
        } else {
        ...
        if (settableBeanProperty != null) {
          ...
          if (propertyValueBuffer.assignParameter(settableBeanProperty.getPropertyIndex(), object1)) {
            ...
            if (object2.getClass() != this._beanType.getRawClass())
              throw paramDeserializationContext.mappingException("Can not create polymorphic instances with unwrapped values"); 
            return this._unwrappedPropertyHandler.processUnwrapped(paramJsonParser, paramDeserializationContext, object2, tokenBuffer);
          } 
        } else {
    ...
    while (true) {
      ...
      if (iterator.hasNext()) {
        ...
        if (!settableBeanProperty5.hasValueDeserializer()) {
          settableBeanProperty3 = settableBeanProperty5.withValueDeserializer(findDeserializer(paramDeserializationConfig, paramDeserializerProvider, settableBeanProperty5.getType(), settableBeanProperty5));
        } else {
          settableBeanProperty3 = settableBeanProperty5;
        } 
        SettableBeanProperty settableBeanProperty3 = _resolveManagedReferenceProperty(paramDeserializationConfig, settableBeanProperty3);
        SettableBeanProperty settableBeanProperty4 = _resolveUnwrappedProperty(paramDeserializationConfig, settableBeanProperty3);
        if (settableBeanProperty4 != null) {
          ...
          unwrappedPropertyHandler2.addProperty(settableBeanProperty4);
          settableBeanProperty = settableBeanProperty4;
        } else {
          UnwrappedPropertyHandler unwrappedPropertyHandler = unwrappedPropertyHandler2;
          settableBeanProperty2 = settableBeanProperty;
          unwrappedPropertyHandler1 = unwrappedPropertyHandler;
        } 
        settableBeanProperty4 = _resolveInnerClassValuedProperty(paramDeserializationConfig, (SettableBeanProperty)unwrappedPropertyHandler1);
        if (settableBeanProperty4 != settableBeanProperty5)
          this._beanProperties.replace(settableBeanProperty4); 
        settableBeanProperty1 = settableBeanProperty2;
        if (settableBeanProperty4.hasValueTypeDeserializer()) {
          TypeDeserializer typeDeserializer = settableBeanProperty4.getValueTypeDeserializer();
          settableBeanProperty1 = settableBeanProperty2;
          if (typeDeserializer.getTypeInclusion() == JsonTypeInfo.As.EXTERNAL_PROPERTY) {
            if (builder == null)
              builder = new ExternalTypeHandler.Builder(); 
            builder.addExternal(settableBeanProperty4, typeDeserializer.getPropertyName());
            this._beanProperties.remove(settableBeanProperty4);
            settableBeanProperty1 = settableBeanProperty2;
          } 
        } 
        continue;
      ...
      if (this._propertyBasedCreator != null)
        for (SettableBeanProperty settableBeanProperty2 : this._propertyBasedCreator.getCreatorProperties()) {
          if (!settableBeanProperty2.hasValueDeserializer())
            this._propertyBasedCreator.assignDeserializer(settableBeanProperty2, findDeserializer(paramDeserializationConfig, paramDeserializerProvider, settableBeanProperty2.getType(), settableBeanProperty2)); 
        }  
      if (builder != null) {
        this._externalTypeIdHandler = builder.build();
        this._nonStandardCreation = true;
      } 
      this._unwrappedPropertyHandler = (UnwrappedPropertyHandler)settableBeanProperty1;
      if (settableBeanProperty1 != null)
        this._nonStandardCreation = true; 
      return;
    } 
...
/* Location:              C:\Users\walle\Downloads\boomlings-1-20 (2)\classes-dex2jar.jar!\com\flurry\org\codehaus\jackson\map\deser\BeanDeserializer.class
