...
public class StdDateFormat extends DateFormat {
  ...
  public Date parse(String paramString) {
    ...
    stringBuilder.append('"');
    throw new ParseException(String.format("Can not parse date \"%s\": not compatible with any of standard forms (%s)", new Object[] { paramString, stringBuilder.toString() }), parsePosition.getErrorIndex());
  }
...
/* Location:              C:\Users\walle\Downloads\boomlings-1-20 (2)\classes-dex2jar.jar!\com\flurry\org\codehaus\jackson\ma\\util\StdDateFormat.class
