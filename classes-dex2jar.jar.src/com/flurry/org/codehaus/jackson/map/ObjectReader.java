...
public class ObjectReader extends ObjectCodec implements Versioned {
  ...
  protected JsonNode _bindAsTree(JsonParser paramJsonParser) {
    ...
    JsonNode jsonNode = (JsonNode)jsonNode.deserialize(paramJsonParser, deserializationContext);
    paramJsonParser.clearCurrentToken();
    return jsonNode;
  }
...
/* Location:              C:\Users\walle\Downloads\boomlings-1-20 (2)\classes-dex2jar.jar!\com\flurry\org\codehaus\jackson\map\ObjectReader.class
