...
public class TypeNameIdResolver extends TypeIdResolverBase {
  ...
  public String idFromValue(Object paramObject) {
    ...
    synchronized (this._typeToId) {
      paramObject = this._typeToId.get(str);
      Object object = paramObject;
      if (paramObject == null) {
        if (this._config.isAnnotationProcessingEnabled()) {
          paramObject = this._config.introspectClassAnnotations(clazz);
          paramObject = this._config.getAnnotationIntrospector().findTypeName(paramObject.getClassInfo());
        } 
        object = paramObject;
        if (paramObject == null)
          object = _defaultTypeId(clazz); 
        this._typeToId.put(str, object);
      } 
...
/* Location:              C:\Users\walle\Downloads\boomlings-1-20 (2)\classes-dex2jar.jar!\com\flurry\org\codehaus\jackson\map\jsontype\impl\TypeNameIdResolver.class
