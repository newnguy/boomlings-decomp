...
class Schema$EnumSchema extends Schema$NamedSchema {
  ...
  public Schema$EnumSchema(Schema$Name paramSchema$Name, String paramString, Schema$LockableArrayList paramSchema$LockableArrayList) {
    ...
    for (byte b = 0; iterator.hasNext(); b++) {
      ...
      if (this.ordinals.put(Schema.access$200(str), Integer.valueOf(b)) != null)
...
/* Location:              C:\Users\walle\Downloads\boomlings-1-20 (2)\classes-dex2jar.jar!\com\flurry\org\apache\avro\Schema$EnumSchema.class
