...
public class GenericDatumWriter implements DatumWriter {
  ...
  protected void writeMap(Schema paramSchema, Object paramObject, Encoder paramEncoder) {
    ...
    while (paramObject.hasNext()) {
      ...
      paramEncoder.startItem();
      writeString(entry.getKey(), paramEncoder);
      write(paramSchema, entry.getValue(), paramEncoder);
    } 
...
/* Location:              C:\Users\walle\Downloads\boomlings-1-20 (2)\classes-dex2jar.jar!\com\flurry\org\apache\avro\generic\GenericDatumWriter.class
