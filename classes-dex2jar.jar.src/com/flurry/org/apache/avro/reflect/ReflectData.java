...
public class ReflectData extends SpecificData {
  ...
  private Protocol.Message getMessage(Method paramMethod, Protocol paramProtocol, Map paramMap) {
    ...
    for (b = 0; b < arrayOfType.length; b++) {
      String str;
      schema2 = getSchema(arrayOfType[b], paramMap);
      ...
      if (arrayOfString.length == arrayOfType.length) {
        str = arrayOfString[b];
      } else {
    ...
    arrayOfType = paramMethod.getGenericExceptionTypes();
...
/* Location:              C:\Users\walle\Downloads\boomlings-1-20 (2)\classes-dex2jar.jar!\com\flurry\org\apache\avro\reflect\ReflectData.class
