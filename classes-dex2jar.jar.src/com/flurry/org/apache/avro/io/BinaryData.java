...
public class BinaryData {
  ...
  public static int encodeDouble(double paramDouble, byte[] paramArrayOfbyte, int paramInt) {
    ...
    int j = (int)(l & 0xFFFFFFFFFFFFFFFFL);
    int i = (int)(l >>> 32L & 0xFFFFFFFFFFFFFFFFL);
    paramArrayOfbyte[paramInt] = (byte)(j & 0xFF);
    paramArrayOfbyte[paramInt + 4] = (byte)(i & 0xFF);
    paramArrayOfbyte[paramInt + 5] = (byte)(i >>> 8 & 0xFF);
    paramArrayOfbyte[paramInt + 1] = (byte)(j >>> 8 & 0xFF);
    paramArrayOfbyte[paramInt + 2] = (byte)(j >>> 16 & 0xFF);
    paramArrayOfbyte[paramInt + 6] = (byte)(i >>> 16 & 0xFF);
    paramArrayOfbyte[paramInt + 7] = (byte)(i >>> 24 & 0xFF);
    paramArrayOfbyte[paramInt + 3] = (byte)(j >>> 24 & 0xFF);
    return 8;
  }
...
/* Location:              C:\Users\walle\Downloads\boomlings-1-20 (2)\classes-dex2jar.jar!\com\flurry\org\apache\avro\io\BinaryData.class
