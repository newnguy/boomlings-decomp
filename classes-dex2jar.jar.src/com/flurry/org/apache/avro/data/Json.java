  ...
  public static void write(JsonNode paramJsonNode, Encoder paramEncoder) {
    switch (Json$1.$SwitchMap$org$codehaus$jackson$JsonToken[paramJsonNode.asToken().ordinal()]) {
      ...
      case 7:
        ...
        for (JsonNode paramJsonNode : paramJsonNode) {
          paramEncoder.startItem();
          write(paramJsonNode, paramEncoder);
        } 
...
/* Location:              C:\Users\walle\Downloads\boomlings-1-20 (2)\classes-dex2jar.jar!\com\flurry\org\apache\avro\data\Json.class
