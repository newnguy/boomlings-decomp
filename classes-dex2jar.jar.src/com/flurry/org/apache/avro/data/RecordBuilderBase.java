...
public abstract class RecordBuilderBase implements RecordBuilder {
  ...
  protected static boolean isValidValue(Schema.Field paramField, Object paramObject) {
    ...
    if (paramObject != null)
      return true; 
    Schema schema = paramField.schema();
    paramObject = schema.getType();
    if (paramObject == Schema.Type.NULL)
      return true; 
    if (paramObject == Schema.Type.UNION) {
      iterator = schema.getTypes().iterator();
...
/* Location:              C:\Users\walle\Downloads\boomlings-1-20 (2)\classes-dex2jar.jar!\com\flurry\org\apache\avro\data\RecordBuilderBase.class
