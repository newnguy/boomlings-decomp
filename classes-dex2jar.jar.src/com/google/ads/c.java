...
public class c {
  ...
  private static a a(JSONObject paramJSONObject) {
    String str1;
    String str3 = paramJSONObject.getString("id");
    ...
    return new a(str2, str3, arrayList, list, (HashMap)str1);
  }
  ...
  public static c a(String paramString) {
    ...
    if (jSONObject2 != null) {
      ...
      List list4 = a(jSONObject2, "imp_urls");
      List list5 = a(jSONObject2, "click_urls");
      List list6 = a(jSONObject2, "nofill_urls");
      Integer integer1 = integer;
      List list3 = list6;
      return new c(str2, str1, arrayList, (Integer)jSONObject1, integer1, list4, list5, list3);
    } 
    integer = null;
    List list1 = null;
    List list2 = null;
    jSONObject2 = null;
    jSONObject1 = null;
    return new c(str2, str1, arrayList, (Integer)jSONObject1, (Integer)jSONObject2, list1, list2, (List)integer);
  }
...
/* Location:              C:\Users\walle\Downloads\boomlings-1-20 (2)\classes-dex2jar.jar!\com\google\ads\c.class
