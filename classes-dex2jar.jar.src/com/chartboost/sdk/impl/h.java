  ...
  public void a(JSONObject paramJSONObject) {
    ...
    for (byte b1 = 0;; b1++) {
      ...
      if (b1 >= jSONArray.length()) {
        h$2 = new h$2(this);
        h$3 = new h$3(this);
        h$4 h$4 = new h$4(this);
        a("close", h$2);
        a("header-center", h$3);
        a("header-tile", h$4);
        return;
      } 
      JSONObject jSONObject = h$3.optJSONObject(b1);
      ...
      if (str.equals("regular")) {
        ...
        if (jSONObject != null) {
          ...
          a(jSONObject, "icon", h$2, bundle);
        } 
      } else if (bundle.equals("featured")) {
        jSONObject = jSONObject.optJSONObject("assets");
        if (jSONObject != null) {
          this.e++;
          bundle = new Bundle();
          bundle.putInt("index", b1);
          a(jSONObject, "portrait", h$2, bundle);
          this.e++;
          bundle = new Bundle();
          bundle.putInt("index", b1);
          a(jSONObject, "landscape", h$2, bundle);
        } 
      } else {
        bundle.equals("webview");
      } 
    } 
  }
...
/* Location:              C:\Users\walle\Downloads\boomlings-1-20 (2)\classes-dex2jar.jar!\com\chartboost\sdk\impl\h.class
