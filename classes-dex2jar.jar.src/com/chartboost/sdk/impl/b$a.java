...
public class b$a extends b.b {
  ...
  protected void a(int paramInt1, int paramInt2) {
    ...
    layoutParams3.width = (int)(a2.c() / f1);
    layoutParams3.height = (int)(a2.d() / f1);
    if (bool) {
      str2 = "frame-portrait";
    } else {
    ...
    Point point2 = a(str2);
    layoutParams3.leftMargin = Math.round((paramInt1 - layoutParams3.width) / 2.0F + point2.x / f1);
    float f2 = (paramInt2 - layoutParams3.height) / 2.0F;
    layoutParams3.topMargin = Math.round(point2.y / f1 + f2);
    this.d.setId(100);
    layoutParams1.width = (int)(a1.c() / f1);
    layoutParams1.height = (int)(a1.d() / f1);
    if (bool) {
      str1 = "ad-portrait";
    } else {
      str1 = "ad-landscape";
    ...
    Point point1 = a(str1);
    layoutParams1.leftMargin = Math.round((paramInt1 - layoutParams1.width) / 2.0F + point1.x / f1);
    f2 = (paramInt2 - layoutParams1.height) / 2.0F;
    layoutParams1.topMargin = Math.round(point1.y / f1 + f2);
    layoutParams2.width = (int)(this.g.l.c() / f1);
    layoutParams2.height = (int)(this.g.l.d() / f1);
    point1 = a("close");
    layoutParams2.leftMargin = layoutParams1.leftMargin + layoutParams1.width + Math.round(point1.x / f1 - d.b(10, getContext()));
    paramInt1 = layoutParams1.topMargin;
    paramInt2 = layoutParams2.height;
    layoutParams2.topMargin = Math.round(point1.y / f1 - d.b(10, getContext())) + paramInt1 - paramInt2;
...
/* Location:              C:\Users\walle\Downloads\boomlings-1-20 (2)\classes-dex2jar.jar!\com\chartboost\sdk\impl\b$a.class
