...
public class an {
  ...
  public static String a(NodeList paramNodeList) {
    ...
    if (null != null) {
      ...
      for (null = ""; b < i; null = str) {
        Node node = nodeList.item(b);
        String str = null;
        if (node != null)
          str = null + node.getNodeValue(); 
        b++;
      } 
      return (null != null && !null.equals("")) ? null.trim() : null;
    } 
    return null;
  }
...
/* Location:              C:\Users\walle\Downloads\boomlings-1-20 (2)\classes-dex2jar.jar!\com\tapjoy\an.class
