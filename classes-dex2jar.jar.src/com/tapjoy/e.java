...
class e extends WebViewClient {
  ...
  public boolean shouldOverrideUrlLoading(WebView paramWebView, String paramString) {
    ...
    if (paramString.startsWith("tjvideo://")) {
      ...
      String str3 = (String)hashtable.get("video_id");
      str2 = (String)hashtable.get("amount");
      str4 = (String)hashtable.get("currency_name");
      paramString = (String)hashtable.get("click_url");
      String str1 = (String)hashtable.get("video_complete_url");
      String str5 = (String)hashtable.get("video_url");
      aj.a("Offers", "videoID: " + str3);
      aj.a("Offers", "currencyAmount: " + str2);
      aj.a("Offers", "currencyName: " + str4);
      aj.a("Offers", "clickURL: " + paramString);
      aj.a("Offers", "webviewURL: " + str1);
      aj.a("Offers", "videoURL: " + str5);
      if (ao.a().a(str3, str4, str2, paramString, str1, str5)) {
        aj.a("Offers", "VIDEO");
        return true;
      } 
      aj.b("Offers", "Unable to play video: " + str3);
...
/* Location:              C:\Users\walle\Downloads\boomlings-1-20 (2)\classes-dex2jar.jar!\com\tapjoy\e.class
