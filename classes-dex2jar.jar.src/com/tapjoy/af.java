...
class af extends WebViewClient {
  ...
  public boolean shouldOverrideUrlLoading(WebView paramWebView, String paramString) {
    ...
    if (paramString.startsWith("tjvideo://")) {
      ...
      paramString = (String)hashtable.get("amount");
      String str3 = (String)hashtable.get("currency_name");
      String str1 = (String)hashtable.get("click_url");
      str4 = (String)hashtable.get("video_complete_url");
      String str5 = (String)hashtable.get("video_url");
      aj.a("Full Screen Ad", "videoID: " + str2);
      aj.a("Full Screen Ad", "currencyAmount: " + paramString);
      aj.a("Full Screen Ad", "currencyName: " + str3);
      aj.a("Full Screen Ad", "clickURL: " + str1);
      aj.a("Full Screen Ad", "webviewURL: " + str4);
      aj.a("Full Screen Ad", "videoURL: " + str5);
      if (ao.a().a(str2, str3, paramString, str1, str4, str5)) {
        aj.a("Full Screen Ad", "VIDEO");
        return true;
      } 
      aj.b("Full Screen Ad", "Unable to play video: " + str2);
...
/* Location:              C:\Users\walle\Downloads\boomlings-1-20 (2)\classes-dex2jar.jar!\com\tapjoy\af.class
