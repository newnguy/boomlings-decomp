...
public class h {
  ...
  private static boolean g(String paramString) {
    ...
    if (document != null) {
      String str = an.a(document.getElementsByTagName("PackageNames"));
      if (str != null && str.length() > 0) {
        Vector<String> vector = new Vector();
        for (int i = 0;; i = j + 1) {
          int j = str.indexOf(',', i);
          if (j == -1) {
            aj.a("TapjoyConnect", "parse: " + str.substring(i).trim());
            vector.add(str.substring(i).trim());
            P = "";
          ...
          aj.a("TapjoyConnect", "parse: " + str.substring(i, j).trim());
          vector.add(str.substring(i, j).trim());
        } 
      } 
  ...
  private static String n() {
    ...
    str2 = str1 + "display_multiplier=" + Uri.encode(Float.toString(K));
    str1 = str2;
    if (x.length() > 0) {
      str1 = str2 + "&";
      str1 = str1 + "carrier_name=" + Uri.encode(x);
    } 
    str2 = str1;
    if (y.length() > 0) {
      str1 = str1 + "&";
      str2 = str1 + "carrier_country_code=" + Uri.encode(y);
    } 
    str1 = str2;
    if (z.length() > 0) {
      str1 = str2 + "&";
      str1 = str1 + "mobile_country_code=" + Uri.encode(z);
    } 
    str2 = str1;
    if (A.length() > 0) {
      str1 = str1 + "&";
    ...
    if (t.length() > 0) {
      ...
      if (u.length() > 0) {
        ...
        str3 = str1 + "screen_layout_size=" + Uri.encode(u);
      } 
    } 
    B = g();
    str1 = str3;
    if (B.length() > 0) {
      str1 = str3 + "&";
      str1 = str1 + "connection_type=" + Uri.encode(B);
    } 
    str2 = str1;
    if (G.length() > 0) {
      str1 = str1 + "&";
      str2 = str1 + "plugin=" + Uri.encode(G);
    } 
    str1 = str2;
    if (H.length() > 0) {
      str1 = str2 + "&";
      str1 = str1 + "sdk_type=" + Uri.encode(H);
    } 
    str2 = str1;
    if (C.length() > 0) {
      str1 = str1 + "&";
      str2 = str1 + "store_name=" + Uri.encode(C);
    } 
    return str2;
  }
...
/* Location:              C:\Users\walle\Downloads\boomlings-1-20 (2)\classes-dex2jar.jar!\com\tapjoy\h.class
