  ...
  public void onComplete(String paramString, Object paramObject) {
    try {
      ...
      if (as.this.requestID_ != null) {
        ...
        String str = as.this.requestID_;
        ay ay = new ay();
        this();
        a.a(str, (Bundle)paramObject, ay);
      } 
...
/* Location:              C:\Users\walle\Downloads\boomlings-1-20 (2)\classes-dex2jar.jar!\org\cocos2dx\lib\az.class
