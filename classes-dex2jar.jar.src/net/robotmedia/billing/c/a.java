...
public class a {
  ...
  public a(byte[] paramArrayOfbyte, String paramString) {
    try {
      ...
      IvParameterSpec ivParameterSpec1 = new IvParameterSpec();
      this(a);
      cipher2.init(1, secretKeySpec, ivParameterSpec1);
      this.c = Cipher.getInstance("AES/CBC/PKCS5Padding");
      Cipher cipher1 = this.c;
      IvParameterSpec ivParameterSpec2 = new IvParameterSpec();
      this(a);
      cipher1.init(2, secretKeySpec, ivParameterSpec2);
      return;
