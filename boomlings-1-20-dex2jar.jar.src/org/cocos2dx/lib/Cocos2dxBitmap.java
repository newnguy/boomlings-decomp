...
public class Cocos2dxBitmap {
    ...
    if (paramInt1 == 0) {
      ...
      while (true) {
        if (paramInt2 < j) {
          ...
          int k = (int)Math.ceil(paramPaint.measureText(paramString, 0, paramString.length()));
          if (k > paramInt1)
            paramInt1 = k; 
          paramInt2++;
          continue;
  ...
  public static void createTextBitmap(String paramString1, String paramString2, int paramInt1, int paramInt2, int paramInt3, int paramInt4) {
    ...
    paramInt3 = computeY(paint.getFontMetricsInt(), paramInt4, ab.b, paramInt2);
    ...
    for (paramInt1 = 0;; paramInt1++) {
      ...
      canvas.drawText(str, computeX(paint, str, ab.a, paramInt2), paramInt3, paint);
      paramInt3 += ab.c;
    } 
  }
...
/* Location:              C:\Users\walle\Downloads\boomlings-1-20 (2)\boomlings-1-20-dex2jar.jar!\org\cocos2dx\lib\Cocos2dxBitmap.class
