...
public class Cocos2dxActivity extends AbstractBillingActivity {
  ...
  public static void encryptFile(String paramString) {
    File file2 = new File(paramString);
    File file3 = new File(String.valueOf(paramString) + "x1");
    File file1 = new File(String.valueOf(paramString) + "x");
    if (file2.exists()) {
      if (!file3.exists())
        file3.createNewFile(); 
    ...
    while (true) {
      if (!iterator.hasNext()) {
        ...
        while (true) {
          if (!iterator.hasNext())
            return; 
          a.c((Context)this, iterator.next());
        } 
        break;
      } 
      c c = iterator.next();
...
/* Location:              C:\Users\walle\Downloads\boomlings-1-20 (2)\boomlings-1-20-dex2jar.jar!\org\cocos2dx\lib\Cocos2dxActivity.class
