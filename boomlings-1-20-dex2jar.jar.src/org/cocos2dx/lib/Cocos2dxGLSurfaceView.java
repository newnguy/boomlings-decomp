    ...
    while (true) {
      if (i >= j) {
        switch (paramMotionEvent.getAction() & 0xFF) {
          ...
          case 0:
            queueEvent(new al(this, paramMotionEvent.getPointerId(0), arrayOfFloat2[0], arrayOfFloat1[0]));
          case 2:
            queueEvent(new am(this, arrayOfInt, arrayOfFloat2, arrayOfFloat1));
          case 6:
            i = paramMotionEvent.getAction() >> 8;
            queueEvent(new an(this, paramMotionEvent.getPointerId(i), paramMotionEvent.getX(i), paramMotionEvent.getY(i)));
          case 1:
            queueEvent(new ad(this, paramMotionEvent.getPointerId(0), arrayOfFloat2[0], arrayOfFloat1[0]));
          case 3:
            break;
        } 
      } else {
        arrayOfInt[i] = paramMotionEvent.getPointerId(i);
        arrayOfFloat2[i] = paramMotionEvent.getX(i);
        arrayOfFloat1[i] = paramMotionEvent.getY(i);
        i++;
        continue;
      } 
      queueEvent(new ae(this, arrayOfInt, arrayOfFloat2, arrayOfFloat1));
    } 
  }
...
/* Location:              C:\Users\walle\Downloads\boomlings-1-20 (2)\boomlings-1-20-dex2jar.jar!\org\cocos2dx\lib\Cocos2dxGLSurfaceView.class
