      ...
      while (true) {
        if (iterator.hasNext()) {
          ...
          if (object instanceof Set) {
            try {
              jSONObject.put((String)classCastException, a((Set)object));
            } catch (ClassCastException classCastException1) {
              b.d("Unknown map type in json serialization: ", classCastException1);
            } 
            continue;
          } 
...
/* Location:              C:\Users\walle\Downloads\boomlings-1-20 (2)\boomlings-1-20-dex2jar.jar!\com\google\ad\\util\AdUtil.class
