...
public class ab implements n {
  ...
  public void a(d paramd, HashMap paramHashMap, WebView paramWebView) {
    ...
    boolean bool2 = str2.equals("new");
    boolean bool1 = str2.equals("position");
    if (bool2 || bool1) {
      DisplayMetrics displayMetrics = AdUtil.a(adActivity);
      int m = a(paramHashMap, "x", 0, displayMetrics);
      int i = a(paramHashMap, "y", 0, displayMetrics);
      int j = a(paramHashMap, "w", -1, displayMetrics);
      int k = a(paramHashMap, "h", -1, displayMetrics);
      if (bool2 && adActivity.a() == null) {
        adActivity.b(m, i, j, k);
        return;
      } 
      adActivity.a(m, i, j, k);
      return;
    } 
...
/* Location:              C:\Users\walle\Downloads\boomlings-1-20 (2)\boomlings-1-20-dex2jar.jar!\com\google\ads\ab.class
