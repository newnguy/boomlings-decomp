...
public class d {
  ...
  public d(Ad paramAd, Activity paramActivity, AdSize paramAdSize, String paramString, ViewGroup paramViewGroup, boolean paramBoolean) {
    ...
    synchronized (a) {
      ...
      if (paramBoolean) {
        ...
        this();
        long l1 = interstitialAd.getLong(stringBuilder.append("Timeout").append(paramString).toString(), -1L);
        if (l1 < 0L) {
          this.i = 5000L;
        } else {
          this.i = l1;
  ...
  protected void A() {
    ...
    //   16: aload_3
    //   17: ifnonnull -> 29
    //   20: ldc_w 'activity was null while trying to ping click tracking URLs.'
    //   23: invokestatic e : (Ljava/lang/String;)V
    //   26: aload_0
    //   27: monitorexit
    //   28: return
    //   29: aload_0
    //   30: getfield t : Ljava/util/LinkedList;
  ...
  public void w() {
    ...
    //   16: aload_2
    //   17: ifnonnull -> 29
    //   20: ldc_w 'activity was null while trying to ping tracking URLs.'
    //   23: invokestatic e : (Ljava/lang/String;)V
    //   26: aload_0
    //   27: monitorexit
    //   28: return
    //   29: aload_0
    //   30: getfield s : Ljava/util/LinkedList;
    //   33: invokevirtual iterator : ()Ljava/util/Iterator;
    //   36: astore_3
    //   37: aload_3
    ...
    //   55: astore_1
    //   56: new java/lang/Thread
    //   59: astore #4
    //   61: new com/google/ads/ac
    //   64: astore #5
    //   66: aload #5
    //   68: aload_1
    //   69: aload_2
    //   70: invokevirtual getApplicationContext : ()Landroid/content/Context;
    //   73: invokespecial <init> : (Ljava/lang/String;Landroid/content/Context;)V
    //   76: aload #4
    //   78: aload #5
    //   80: invokespecial <init> : (Ljava/lang/Runnable;)V
    //   83: aload #4
...
/* Location:              C:\Users\walle\Downloads\boomlings-1-20 (2)\boomlings-1-20-dex2jar.jar!\com\google\ads\internal\d.class
