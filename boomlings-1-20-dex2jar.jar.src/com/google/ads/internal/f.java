...
public final class f implements Runnable {
  ...
  private void f(HttpURLConnection paramHttpURLConnection) {
    str = paramHttpURLConnection.getHeaderField("X-Afma-Tracking-Urls");
    if (!TextUtils.isEmpty(str))
  ...
  private void g(HttpURLConnection paramHttpURLConnection) {
    String str = paramHttpURLConnection.getHeaderField("X-Afma-Click-Tracking-Urls");
    if (!TextUtils.isEmpty(str))
  ...
  private void l(HttpURLConnection paramHttpURLConnection) {
    ...
    if (!TextUtils.isEmpty(str))
      try {
        ...
        int j = Integer.parseInt((String)stringBuilder[0]);
        int i = Integer.parseInt((String)stringBuilder[1]);
        this.a.a(new AdSize(j, i));
      } catch (NumberFormatException numberFormatException) {
...
/* Location:              C:\Users\walle\Downloads\boomlings-1-20 (2)\boomlings-1-20-dex2jar.jar!\com\google\ads\internal\f.class
