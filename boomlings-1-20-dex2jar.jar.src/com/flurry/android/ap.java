    ...
    if (str.equals("nextAdUnit")) {
      ...
      if (x.equals("nextFrame")) {
        ...
        if (str2 != null)
          if (str2.equals("next")) {
            ...
            try {
              ...
              "caught: " + numberFormatException.getMessage();
              paramInt = i;
            } 
          } else {
            return;
        ...
        if (map.containsKey("message") && map.containsKey("confirmDisplay") && map.containsKey("cancelDisplay")) {
          str1 = (String)map.get("message");
          str3 = (String)map.get("confirmDisplay");
        ...
        builder.setMessage(str1).setCancelable(false).setPositiveButton(str2, new av(this, bj, paramInt)).setNegativeButton(str3, new ar(this, bj, paramInt));
        ...
        if (list.size() > 0) {
          this.c.a().toString();
          str1 = a(list);
          this.h.loadUrl("javascript:(function() {var multiadwraps=document.getElementsByClassName('multiAdWrap');if(multiadwraps.length>0){var template=document.getElementsByClassName('multiAdWrap')[0];var compiled=Hogan.compile(template.innerHTML);template.innerHTML='';template.innerHTML=compiled.render(JSON.parse(" + str1 + "));}})();");
        ...
        if (adUnit.equals("doExpand")) {
          ...
          paramInt = ((AdFrame)this.r.get(this.d)).d().a().intValue();
          int i = ((AdFrame)this.r.get(this.d)).d().b().intValue();
          ...
          try {
            if ((x)getParent() != null && this.o != null) {
              StringBuilder stringBuilder = new StringBuilder();
              this();
              stringBuilder.append("collapse(").append(paramInt).append(",").append(i).append(")").toString();
...
/* Location:              C:\Users\walle\Downloads\boomlings-1-20 (2)\boomlings-1-20-dex2jar.jar!\com\flurry\android\ap.class
