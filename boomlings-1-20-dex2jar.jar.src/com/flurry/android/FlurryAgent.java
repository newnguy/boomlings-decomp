...
public final class FlurryAgent implements LocationListener {
  ...
  private void a(Context paramContext, String paramString) {
    ...
    //   310: getfield u : J
    //   313: lsub
    //   314: getstatic com/flurry/android/FlurryAgent.f : J
    //   317: lcmp
    //   318: ifle -> 847
    //   321: ldc 'FlurryAgent'
    //   323: ldc_w 'New session'
    //   326: invokestatic a : (Ljava/lang/String;Ljava/lang/String;)I
    //   329: pop
    //   330: aload_0
    ...
    //   350: aload_0
    //   351: ldc ''
    //   353: putfield N : Ljava/lang/String;
    //   356: aload_0
    //   357: iconst_0
    //   358: putfield Q : I
    //   361: aload_0
    //   362: aconst_null
    //   363: putfield R : Landroid/location/Location;
    //   366: aload_0
    //   367: invokestatic getDefault : ()Ljava/util/TimeZone;
    //   370: invokevirtual getID : ()Ljava/lang/String;
    //   373: putfield L : Ljava/lang/String;
    ...
    //   386: aload_0
    //   387: aload #6
    //   389: invokestatic getDefault : ()Ljava/util/Locale;
    //   392: invokevirtual getLanguage : ()Ljava/lang/String;
    ...
    //   404: invokestatic getDefault : ()Ljava/util/Locale;
    //   407: invokevirtual getCountry : ()Ljava/lang/String;
    //   410: invokevirtual append : (Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   413: invokevirtual toString : ()Ljava/lang/String;
    //   416: putfield K : Ljava/lang/String;
    //   419: new java/util/HashMap
    //   422: astore #6
    //   424: aload #6
    //   426: invokespecial <init> : ()V
    //   429: aload_0
    //   430: aload #6
    //   432: putfield S : Ljava/util/Map;
    ...
    //   445: aload_0
    //   446: aload #6
    //   448: putfield T : Ljava/util/List;
    //   451: aload_0
    //   452: iconst_1
    //   453: putfield U : Z
    //   456: new java/util/ArrayList
    //   459: astore #6
    //   461: aload #6
    //   463: invokespecial <init> : ()V
    //   466: aload_0
    //   467: aload #6
    //   469: putfield W : Ljava/util/List;
    //   472: aload_0
    //   473: iconst_0
    //   474: putfield V : I
    //   477: aload_0
    //   478: iconst_0
    //   479: putfield X : I
    //   482: getstatic com/flurry/android/FlurryAgent.l : Z
    //   485: ifeq -> 504
    //   488: aload_0
    //   489: getfield ab : Lcom/flurry/android/bo;
    //   492: aload_1
    //   493: aload_0
    //   494: getfield H : J
    //   497: aload_0
    //   498: getfield I : J
    //   501: invokevirtual a : (Landroid/content/Context;JJ)V
    //   504: aload_0
    //   505: getfield z : Z
    //   508: istore_3
    //   509: new com/flurry/android/e
    //   512: astore #6
    //   514: aload #6
    //   516: aload_0
    //   517: aload_2
    //   518: iload_3
    //   519: invokespecial <init> : (Lcom/flurry/android/FlurryAgent;Landroid/content/Context;Z)V
    //   522: aload_0
    //   523: aload #6
    //   525: invokespecial a : (Lcom/flurry/android/an;)V
    //   528: aload_1
    //   529: instanceof android/app/Activity
    //   532: ifeq -> 903
    //   535: aload_1
    //   536: checkcast android/app/Activity
    //   539: invokevirtual getIntent : ()Landroid/content/Intent;
    //   542: invokevirtual getExtras : ()Landroid/os/Bundle;
    //   545: astore_2
    //   546: aload_2
    //   547: ifnull -> 903
    ...
    //   558: ldc 'FlurryAgent'
    //   560: aload_1
    //   561: ldc_w 'Launch Options Bundle is present '
    ...
    //   577: invokestatic a : (Ljava/lang/String;Ljava/lang/String;)I
    //   580: pop
    ...
    //   589: aload_0
    //   590: aload_1
    //   591: putfield aa : Ljava/util/Map;
    //   594: aload_2
    //   595: invokevirtual keySet : ()Ljava/util/Set;
    ...
    //   625: astore #7
    //   627: aload_0
    //   628: getfield aa : Ljava/util/Map;
    //   631: aload #7
    //   633: invokeinterface get : (Ljava/lang/Object;)Ljava/lang/Object;
    //   638: ifnonnull -> 667
    //   641: aload_0
    //   642: getfield aa : Ljava/util/Map;
    //   645: astore_1
    //   646: new java/util/ArrayList
    //   649: astore #8
    //   651: aload #8
    ...
    //   657: aload #7
    //   659: aload #8
    //   661: invokeinterface put : (Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   666: pop
    //   667: aload_2
    //   668: aload #7
    //   670: invokevirtual get : (Ljava/lang/String;)Ljava/lang/Object;
    //   673: astore_1
    //   674: aload_1
    //   675: invokevirtual getClass : ()Ljava/lang/Class;
    //   678: ldc ''
    //   680: invokevirtual isInstance : (Ljava/lang/Object;)Z
    //   683: ifeq -> 764
    //   686: aload_2
    //   687: aload #7
    ...
    //   752: invokestatic a : (Ljava/lang/String;Ljava/lang/String;)I
    //   755: pop
    //   756: goto -> 605
    //   759: astore_1
    //   760: aload_0
    ...
    //   772: invokevirtual isInstance : (Ljava/lang/Object;)Z
    //   775: ifeq -> 793
    //   778: aload_2
    //   779: aload #7
    //   781: invokevirtual getInt : (Ljava/lang/String;)I
    //   784: pop
    //   785: iconst_0
    ...
    //   797: lconst_0
    //   798: invokestatic valueOf : (J)Ljava/lang/Long;
    //   801: invokevirtual isInstance : (Ljava/lang/Object;)Z
    //   804: ifeq -> 820
    //   807: aload_2
    //   808: aload #7
    //   810: invokevirtual getLong : (Ljava/lang/String;)J
    //   813: invokestatic toString : (J)Ljava/lang/String;
    //   816: astore_1
    //   817: goto -> 693
    //   820: aload_1
    //   821: invokevirtual getClass : ()Ljava/lang/Class;
    //   824: iconst_0
    //   825: invokestatic valueOf : (Z)Ljava/lang/Boolean;
    //   828: invokevirtual isInstance : (Ljava/lang/Object;)Z
    //   831: ifeq -> 911
    //   834: aload_2
    //   835: aload #7
    //   837: invokevirtual getBoolean : (Ljava/lang/String;)Z
    //   840: invokestatic toString : (Z)Ljava/lang/String;
    //   843: astore_1
    //   844: goto -> 693
    //   847: ldc 'FlurryAgent'
    //   849: ldc_w 'Continuing previous session'
    //   852: invokestatic a : (Ljava/lang/String;Ljava/lang/String;)I
    //   855: pop
    //   856: aload_0
    //   857: getfield G : Ljava/util/List;
    //   860: invokeinterface isEmpty : ()Z
    //   865: ifne -> 889
    //   868: aload_0
    //   869: getfield G : Ljava/util/List;
    //   872: aload_0
    //   873: getfield G : Ljava/util/List;
    //   876: invokeinterface size : ()I
    //   881: iconst_1
    //   882: isub
    //   883: invokeinterface remove : (I)Ljava/lang/Object;
    //   888: pop
    //   889: getstatic com/flurry/android/FlurryAgent.l : Z
    //   892: ifeq -> 903
    //   895: aload_0
    //   896: getfield ab : Lcom/flurry/android/bo;
    //   899: aload_1
    //   900: invokevirtual a : (Landroid/content/Context;)V
    //   903: aload_0
    //   904: iconst_1
    //   905: putfield s : Z
    //   908: aload_0
  ...
  private void a(DataInputStream paramDataInputStream) {
    ...
    //   56: aload_1
    //   57: aload #4
    //   59: ldc_w 'Unknown agent file version: '
  ...
  private void b(Context paramContext, String paramString) {
    ...
    //   110: astore #4
    //   112: aload_2
    //   113: invokestatic a : (Ljava/io/Closeable;)V
    //   116: aload #4
    //   118: athrow
    //   119: astore #4
    //   121: aload_1
  ...
  private byte[] i() {
    ...
    //   17: aload #6
    //   19: invokespecial <init> : ()V
    //   22: new java/security/DigestOutputStream
    //   25: astore_3
    //   26: aload_3
    //   27: aload #6
    //   29: aload #5
    //   31: invokespecial <init> : (Ljava/io/OutputStream;Ljava/security/MessageDigest;)V
    //   34: new java/io/DataOutputStream
    //   37: astore #4
    //   39: aload #4
    //   41: aload_3
    ...
    //   1075: aload_3
    //   1076: iconst_0
    //   1077: invokevirtual on : (Z)V
    //   1080: aload #4
    //   1082: aload #5
    //   1084: invokevirtual getDigest : ()[B
    //   1087: invokevirtual write : ([B)V
    //   1090: aload #4
    //   1092: invokevirtual close : ()V
    //   1095: aload #6
...
/* Location:              C:\Users\walle\Downloads\boomlings-1-20 (2)\boomlings-1-20-dex2jar.jar!\com\flurry\android\FlurryAgent.class
