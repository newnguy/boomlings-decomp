...
public class ValidatingGrammarGenerator {
  ...
  public Symbol generate(Schema paramSchema, Map<ValidatingGrammarGenerator$LitS, Symbol> paramMap) {
    ...
    Iterator<Schema> iterator1 = iterator.getTypes().iterator();
    for (byte b = 0; iterator1.hasNext(); b++) {
      Schema schema = iterator1.next();
...
/* Location:              C:\Users\walle\Downloads\boomlings-1-20 (2)\boomlings-1-20-dex2jar.jar!\com\flurry\org\apache\avro\io\parsing\ValidatingGrammarGenerator.class
