    ...
    if (l > 0L) {
      ...
      do {
        for (l1 = 0L; l1 < l; l1++) {
          ...
          this.header.meta.put(str, arrayOfByte1);
...
/* Location:              C:\Users\walle\Downloads\boomlings-1-20 (2)\boomlings-1-20-dex2jar.jar!\com\flurry\org\apache\avro\file\DataFileStream.class
