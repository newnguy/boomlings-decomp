...
public class GenericData {
  ...
  protected int compare(Object paramObject1, Object paramObject2, Schema paramSchema, boolean paramBoolean) {
    ...
    switch (GenericData$1.$SwitchMap$org$apache$avro$Schema$Type[paramSchema.getType().ordinal()]) {
      ...
      case 2:
        i = iterator.getEnumOrdinal(paramObject1.toString()) - iterator.getEnumOrdinal(paramObject2.toString());
      case 3:
  ...
  public Object deepCopy(Schema paramSchema, Object<Object, Object> paramObject) {
    ...
    switch (GenericData$1.$SwitchMap$org$apache$avro$Schema$Type[paramSchema.getType().ordinal()]) {
      ...
      case 8:
        paramObject = paramObject;
        arrayOfByte = new byte[paramObject.capacity()];
        paramObject.rewind();
        paramObject.get(arrayOfByte);
        paramObject.rewind();
        object = (Object<Object, Object>)ByteBuffer.wrap(arrayOfByte);
      case 12:
        object = (Object<Object, Object>)new Double(((Double)paramObject).doubleValue());
      case 6:
        object = (Object<Object, Object>)createFixed(null, ((GenericFixed)paramObject).bytes(), (Schema)arrayOfByte);
      case 11:
      ...
      case 4:
        ...
        while (true) {
          if (iterator.hasNext()) {
            ...
            object.put(deepCopy(STRINGS, paramObject.getKey()), deepCopy(arrayOfByte.getValueType(), paramObject.getValue()));
          } 
        } 
      case 14:
        object = null;
      case 1:
        paramObject = paramObject;
        object = (Object<Object, Object>)newRecord(null, (Schema)arrayOfByte);
        iterator = arrayOfByte.getFields().iterator();
        while (true) {
          if (iterator.hasNext()) {
  ...
  protected boolean instanceOf(Schema paramSchema, Object paramObject) {
    ...
    switch (GenericData$1.$SwitchMap$org$apache$avro$Schema$Type[paramSchema.getType().ordinal()]) {
      ...
      case 1:
        return !isRecord(paramObject) ? bool2 : ((paramSchema.getFullName() == null) ? ((getRecordSchema(paramObject).getFullName() == null) ? bool1 : false) : paramSchema.getFullName().equals(getRecordSchema(paramObject).getFullName()));
      case 2:
        null = bool2;
        if (isEnum(paramObject))
      ...
      case 3:
        ...
        if (paramObject instanceof Collection) {
          ...
          while (paramObject.hasNext()) {
            ...
            if (!validate(field.getElementType(), object)) {
              null = bool1;
              // Byte code: goto -> 91
            } 
          } 
...
/* Location:              C:\Users\walle\Downloads\boomlings-1-20 (2)\boomlings-1-20-dex2jar.jar!\com\flurry\org\apache\avro\generic\GenericData.class
