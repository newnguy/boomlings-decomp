...
public final class Base64Variant {
  ...
  public String encode(byte[] paramArrayOfbyte, boolean paramBoolean) {
    ...
    while (i <= k - 3) {
      ...
      int m = n + 1;
      encodeBase64Chunk(stringBuilder, (i << 8 | paramArrayOfbyte[n] & 0xFF) << 8 | paramArrayOfbyte[m] & 0xFF);
      i = --j;
      if (j <= 0) {
        stringBuilder.append('\\');
...
/* Location:              C:\Users\walle\Downloads\boomlings-1-20 (2)\boomlings-1-20-dex2jar.jar!\com\flurry\org\codehaus\jackson\Base64Variant.class
