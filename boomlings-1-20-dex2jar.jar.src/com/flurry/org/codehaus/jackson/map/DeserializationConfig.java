...
public class DeserializationConfig extends MapperConfig$Impl {
  ...
  public VisibilityChecker getDefaultVisibilityChecker() {
    ...
    if (!isEnabled(DeserializationConfig$Feature.AUTO_DETECT_SETTERS))
      visibilityChecker1 = visibilityChecker2.withSetterVisibility(JsonAutoDetect.Visibility.NONE); 
    visibilityChecker2 = visibilityChecker1;
    if (!isEnabled(DeserializationConfig$Feature.AUTO_DETECT_CREATORS))
      visibilityChecker2 = visibilityChecker1.withCreatorVisibility(JsonAutoDetect.Visibility.NONE); 
...
/* Location:              C:\Users\walle\Downloads\boomlings-1-20 (2)\boomlings-1-20-dex2jar.jar!\com\flurry\org\codehaus\jackson\map\DeserializationConfig.class
