...
final class PrimitiveArrayDeserializers$CharDeser extends PrimitiveArrayDeserializers$Base {
  ...
  public char[] deserialize(JsonParser paramJsonParser, DeserializationContext paramDeserializationContext) {
    ...
    if (jsonToken == JsonToken.VALUE_STRING) {
      ...
      int j = paramJsonParser.getTextOffset();
      int i = paramJsonParser.getTextLength();
      arrayOfChar1 = new char[i];
      System.arraycopy(arrayOfChar2, j, arrayOfChar1, 0, i);
      return arrayOfChar1;
    } 
...
/* Location:              C:\Users\walle\Downloads\boomlings-1-20 (2)\boomlings-1-20-dex2jar.jar!\com\flurry\org\codehaus\jackson\map\deser\std\PrimitiveArrayDeserializers$CharDeser.class
