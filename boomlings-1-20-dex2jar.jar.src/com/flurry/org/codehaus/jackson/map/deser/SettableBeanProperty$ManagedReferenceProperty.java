    ...
    if (paramObject2 != null)
      if (this._isContainer) {
        if (paramObject2 instanceof Object[]) {
          for (Object paramObject2 : (Object[])paramObject2) {
            if (paramObject2 != null)
              this._backProperty.set(paramObject2, paramObject1); 
          } 
        } else if (paramObject2 instanceof java.util.Collection) {
          for (Object paramObject2 : paramObject2) {
            if (paramObject2 != null)
              this._backProperty.set(paramObject2, paramObject1); 
          } 
...
/* Location:              C:\Users\walle\Downloads\boomlings-1-20 (2)\boomlings-1-20-dex2jar.jar!\com\flurry\org\codehaus\jackson\map\deser\SettableBeanProperty$ManagedReferenceProperty.class
