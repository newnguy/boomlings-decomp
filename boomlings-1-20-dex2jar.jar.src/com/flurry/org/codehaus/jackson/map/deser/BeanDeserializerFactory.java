...
public class BeanDeserializerFactory extends BasicDeserializerFactory {
  ...
  public JsonDeserializer buildBeanDeserializer(DeserializationConfig paramDeserializationConfig, JavaType paramJavaType, BasicBeanDescription paramBasicBeanDescription, BeanProperty paramBeanProperty) {
    ...
    if (this._factoryConfig.hasDeserializerModifiers()) {
      ...
      while (true) {
        ...
        if (iterator.hasNext()) {
          jsonDeserializer = ((BeanDeserializerModifier)iterator.next()).modifyDeserializer(paramDeserializationConfig, paramBasicBeanDescription, jsonDeserializer);
          continue;
        } 
  ...
  protected SettableAnyProperty constructAnySetter(DeserializationConfig paramDeserializationConfig, BasicBeanDescription paramBasicBeanDescription, AnnotatedMethod paramAnnotatedMethod) {
    ...
    JavaType javaType2 = paramBasicBeanDescription.bindingsForBeanType().resolveType(paramAnnotatedMethod.getParameterType(1));
    BeanProperty.Std std = new BeanProperty.Std(paramAnnotatedMethod.getName(), javaType2, paramBasicBeanDescription.getClassAnnotations(), (AnnotatedMember)paramAnnotatedMethod);
    JavaType javaType1 = resolveType(paramDeserializationConfig, paramBasicBeanDescription, javaType2, (AnnotatedMember)paramAnnotatedMethod, (BeanProperty)std);
    ...
    return (jsonDeserializer != null) ? new SettableAnyProperty((BeanProperty)std, paramAnnotatedMethod, javaType1, jsonDeserializer) : new SettableAnyProperty((BeanProperty)std, paramAnnotatedMethod, modifyTypeByAnnotation(paramDeserializationConfig, (Annotated)paramAnnotatedMethod, javaType1, std.getName()), null);
  }
...
/* Location:              C:\Users\walle\Downloads\boomlings-1-20 (2)\boomlings-1-20-dex2jar.jar!\com\flurry\org\codehaus\jackson\map\deser\BeanDeserializerFactory.class
