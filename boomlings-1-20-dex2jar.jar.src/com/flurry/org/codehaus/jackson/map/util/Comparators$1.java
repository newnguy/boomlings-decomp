      ...
      if (paramObject.getClass() == defaultValue.getClass()) {
        ...
        if (Array.getLength(paramObject) == length) {
          for (byte b = 0; b < length; b++) {
            Object object1 = Array.get(defaultValue, b);
...
/* Location:              C:\Users\walle\Downloads\boomlings-1-20 (2)\boomlings-1-20-dex2jar.jar!\com\flurry\org\codehaus\jackson\ma\\util\Comparators$1.class
