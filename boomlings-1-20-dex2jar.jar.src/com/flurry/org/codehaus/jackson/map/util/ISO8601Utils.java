...
public class ISO8601Utils {
  ...
  public static String format(Date paramDate, boolean paramBoolean, TimeZone paramTimeZone) {
    ...
    if (j != 0) {
      byte b;
      k = Math.abs(j / 60000 / 60);
      i = Math.abs(j / 60000 % 60);
      if (j < 0) {
        b = 45;
      } else {
        b = 43;
...
/* Location:              C:\Users\walle\Downloads\boomlings-1-20 (2)\boomlings-1-20-dex2jar.jar!\com\flurry\org\codehaus\jackson\ma\\util\ISO8601Utils.class
