...
public class POJOPropertiesCollector {
    ...
    for (AnnotatedMethod annotatedMethod : this._classDef.memberMethods()) {
      ...
      if (i == 1) {
        ...
        if (str1 == null) {
          ...
          str2 = BeanUtil.okNameForSetter(annotatedMethod);
          String str = str2;
          if (str2 == null)
  ...
  protected void _renameProperties() {
    ...
    if (linkedList != null)
      for (POJOPropertyBuilder pOJOPropertyBuilder1 : linkedList) {
        String str = pOJOPropertyBuilder1.getName();
...
/* Location:              C:\Users\walle\Downloads\boomlings-1-20 (2)\boomlings-1-20-dex2jar.jar!\com\flurry\org\codehaus\jackson\map\introspect\POJOPropertiesCollector.class
