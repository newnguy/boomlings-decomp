...
public class POJOPropertyBuilder extends BeanPropertyDefinition implements Comparable {
  ...
  private POJOPropertyBuilder$Node findRenamed(POJOPropertyBuilder$Node paramPOJOPropertyBuilder$Node1, POJOPropertyBuilder$Node paramPOJOPropertyBuilder$Node2) {
    for (POJOPropertyBuilder$Node pOJOPropertyBuilder$Node = paramPOJOPropertyBuilder$Node2; paramPOJOPropertyBuilder$Node1 != null; pOJOPropertyBuilder$Node = paramPOJOPropertyBuilder$Node2) {
      ...
      if (str == null) {
        ...
        if (!str.equals(this._name))
          if (pOJOPropertyBuilder$Node == null) {
            paramPOJOPropertyBuilder$Node2 = paramPOJOPropertyBuilder$Node1;
          } else {
            paramPOJOPropertyBuilder$Node2 = pOJOPropertyBuilder$Node;
            if (!str.equals(pOJOPropertyBuilder$Node.explicitName))
              throw new IllegalStateException("Conflicting property name definitions: '" + pOJOPropertyBuilder$Node.explicitName + "' (for " + pOJOPropertyBuilder$Node.value + ") vs '" + paramPOJOPropertyBuilder$Node1.explicitName + "' (for " + paramPOJOPropertyBuilder$Node1.value + ")"); 
          }  
      } 
      paramPOJOPropertyBuilder$Node1 = paramPOJOPropertyBuilder$Node1.next;
    } 
    return pOJOPropertyBuilder$Node;
  }
  ...
  public AnnotatedField getField() {
    ...
    for (POJOPropertyBuilder$Node pOJOPropertyBuilder$Node = this._fields.next;; pOJOPropertyBuilder$Node = pOJOPropertyBuilder$Node.next) {
      ...
      if (pOJOPropertyBuilder$Node != null) {
        ...
        Class<?> clazz2 = annotatedField1.getDeclaringClass();
        Class<?> clazz1 = annotatedField2.getDeclaringClass();
        if (clazz2 != clazz1) {
...
/* Location:              C:\Users\walle\Downloads\boomlings-1-20 (2)\boomlings-1-20-dex2jar.jar!\com\flurry\org\codehaus\jackson\map\introspect\POJOPropertyBuilder.class
