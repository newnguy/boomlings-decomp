      ...
      if (b < i) {
        ...
        if (!Modifier.isStatic(method.getModifiers())) {
          ...
          if ((method.getParameterTypes()).length != 0) {
            MemberKey[] arrayOfMemberKey;
            if (paramClass == null) {
              MemberKey[] arrayOfMemberKey3 = new MemberKey[j];
              byte b2 = 0;
              while (true) {
                arrayOfMemberKey = arrayOfMemberKey3;
                if (b2 < j) {
...
/* Location:              C:\Users\walle\Downloads\boomlings-1-20 (2)\boomlings-1-20-dex2jar.jar!\com\flurry\org\codehaus\jackson\map\introspect\AnnotatedClass.class
