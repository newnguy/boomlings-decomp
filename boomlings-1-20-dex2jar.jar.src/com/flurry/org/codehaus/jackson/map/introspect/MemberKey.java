...
public final class MemberKey {
  ...
  public boolean equals(Object paramObject) {
    ...
    if (!this._name.equals(((MemberKey)paramObject)._name))
      return false; 
    Class[] arrayOfClass = ((MemberKey)paramObject)._argTypes;
    ...
    while (true) {
      boolean bool1 = bool;
      if (b < i) {
        paramObject = arrayOfClass[b];
        Class<?> clazz = this._argTypes[b];
        if (paramObject != clazz && !paramObject.isAssignableFrom(clazz) && !clazz.isAssignableFrom((Class<?>)paramObject))
          return false; 
        b++;
        continue;
      } 
...
/* Location:              C:\Users\walle\Downloads\boomlings-1-20 (2)\boomlings-1-20-dex2jar.jar!\com\flurry\org\codehaus\jackson\map\introspect\MemberKey.class
