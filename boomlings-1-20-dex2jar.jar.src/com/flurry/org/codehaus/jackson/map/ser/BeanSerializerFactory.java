  ...
  public JsonSerializer findBeanSerializer(SerializationConfig paramSerializationConfig, JavaType paramJavaType, BasicBeanDescription paramBasicBeanDescription, BeanProperty paramBeanProperty) {
    ...
    if (this._factoryConfig.hasSerializerModifiers()) {
      ...
      while (true) {
        ...
        if (iterator.hasNext()) {
          jsonSerializer1 = ((BeanSerializerModifier)iterator.next()).modifySerializer(paramSerializationConfig, paramBasicBeanDescription, jsonSerializer1);
          continue;
        } 
        return jsonSerializer;
      } 
...
/* Location:              C:\Users\walle\Downloads\boomlings-1-20 (2)\boomlings-1-20-dex2jar.jar!\com\flurry\org\codehaus\jackson\map\ser\BeanSerializerFactory.class
