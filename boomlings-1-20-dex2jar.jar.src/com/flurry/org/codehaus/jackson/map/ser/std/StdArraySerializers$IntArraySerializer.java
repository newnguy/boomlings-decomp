...
@JacksonStdImpl
public final class StdArraySerializers$IntArraySerializer extends StdArraySerializers$ArraySerializerBase {
  ...
  public void serializeContents(int[] paramArrayOfint, JsonGenerator paramJsonGenerator, SerializerProvider paramSerializerProvider) {
    ...
    while (b < i) {
      paramJsonGenerator.writeNumber(paramArrayOfint[b]);
      b++;
    } 
  }
}
...
/* Location:              C:\Users\walle\Downloads\boomlings-1-20 (2)\boomlings-1-20-dex2jar.jar!\com\flurry\org\codehaus\jackson\map\ser\std\StdArraySerializers$IntArraySerializer.class
