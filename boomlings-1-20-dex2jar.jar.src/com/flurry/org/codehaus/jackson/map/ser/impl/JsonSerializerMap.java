...
public class JsonSerializerMap {
  ...
  public JsonSerializer find(SerializerCache$TypeKey paramSerializerCache$TypeKey) {
    int i = paramSerializerCache$TypeKey.hashCode();
    int j = this._buckets.length;
    JsonSerializerMap$Bucket jsonSerializerMap$Bucket2 = this._buckets[i & j - 1];
...
/* Location:              C:\Users\walle\Downloads\boomlings-1-20 (2)\boomlings-1-20-dex2jar.jar!\com\flurry\org\codehaus\jackson\map\ser\impl\JsonSerializerMap.class
