...
public abstract class JavaType {
  ...
  public JavaType forcedNarrowBy(Class paramClass) {
    if (paramClass == this._class)
      return this; 
    JavaType javaType2 = _narrow(paramClass);
    JavaType javaType1 = javaType2;
    if (this._valueHandler != javaType2.getValueHandler())
      javaType1 = javaType2.withValueHandler(this._valueHandler); 
    javaType2 = javaType1;
    if (this._typeHandler != javaType1.getTypeHandler())
      javaType2 = javaType1.withTypeHandler(this._typeHandler); 
    return javaType2;
  }
...
/* Location:              C:\Users\walle\Downloads\boomlings-1-20 (2)\boomlings-1-20-dex2jar.jar!\com\flurry\org\codehaus\jackson\type\JavaType.class
