...
public abstract class JsonNode implements Iterable {
  ...
  public final List findParents(String paramString) {
    List<?> list2 = findParents(paramString, null);
    List<?> list1 = list2;
    if (list2 == null)
  ...
  public final List findValues(String paramString) {
    List<?> list2 = findValues(paramString, null);
    List<?> list1 = list2;
    if (list2 == null)
      list1 = Collections.emptyList(); 
    return list1;
  ...
  public final List findValuesAsText(String paramString) {
    List<?> list2 = findValuesAsText(paramString, null);
    List<?> list1 = list2;
    if (list2 == null)
      list1 = Collections.emptyList(); 
    return list1;
...
/* Location:              C:\Users\walle\Downloads\boomlings-1-20 (2)\boomlings-1-20-dex2jar.jar!\com\flurry\org\codehaus\jackson\JsonNode.class
