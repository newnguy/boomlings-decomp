...
public final class NumberOutput {
  ...
  private static int outputFullTriplet(int paramInt1, byte[] paramArrayOfbyte, int paramInt2) {
    ...
    paramInt2 = i + 1;
    paramArrayOfbyte[i] = FULL_TRIPLETS_B[paramInt1];
    paramArrayOfbyte[paramInt2] = FULL_TRIPLETS_B[paramInt1 + 1];
    return paramInt2 + 1;
  }
  ...
  public static int outputInt(int paramInt1, char[] paramArrayOfchar, int paramInt2) {
    ...
    i = j / 1000;
    if (bool) {
      paramInt2 = outputFullTriplet(i, paramArrayOfchar, paramInt2);
    } else {
      paramInt2 = outputLeadingTriplet(i, paramArrayOfchar, paramInt2);
    } 
    return outputFullTriplet(paramInt1 - j * 1000, paramArrayOfchar, outputFullTriplet(j - i * 1000, paramArrayOfchar, paramInt2));
  }
...
/* Location:              C:\Users\walle\Downloads\boomlings-1-20 (2)\boomlings-1-20-dex2jar.jar!\com\flurry\org\codehaus\jackson\io\NumberOutput.class
