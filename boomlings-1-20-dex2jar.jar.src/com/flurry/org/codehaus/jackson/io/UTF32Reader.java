...
public final class UTF32Reader extends BaseReader {
  ...
  private void reportInvalid(int paramInt1, int paramInt2, String paramString) {
    ...
    throw new CharConversionException("Invalid UTF-32 character 0x" + Integer.toHexString(paramInt1) + paramString + " at char #" + (i + paramInt2) + ", byte #" + (j + k - 1) + ")");
  }
...
/* Location:              C:\Users\walle\Downloads\boomlings-1-20 (2)\boomlings-1-20-dex2jar.jar!\com\flurry\org\codehaus\jackson\io\UTF32Reader.class
