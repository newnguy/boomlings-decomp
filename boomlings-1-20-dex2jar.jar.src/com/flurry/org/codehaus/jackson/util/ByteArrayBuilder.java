...
public final class ByteArrayBuilder extends OutputStream {
  ...
  public byte[] toByteArray() {
    ...
    for (i = 0; iterator.hasNext(); i += k) {
      byte[] arrayOfByte1 = iterator.next();
      int k = arrayOfByte1.length;
      System.arraycopy(arrayOfByte1, 0, arrayOfByte, i, k);
    } 
    System.arraycopy(this._currBlock, 0, arrayOfByte, i, this._currBlockPtr);
...
/* Location:              C:\Users\walle\Downloads\boomlings-1-20 (2)\boomlings-1-20-dex2jar.jar!\com\flurry\org\codehaus\jackso\\util\ByteArrayBuilder.class
