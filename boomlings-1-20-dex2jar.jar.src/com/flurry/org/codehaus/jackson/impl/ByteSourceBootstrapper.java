...
public final class ByteSourceBootstrapper {
  ...
  public JsonParser constructParser(int paramInt, ObjectCodec paramObjectCodec, BytesToNameCanonicalizer paramBytesToNameCanonicalizer, CharsToNameCanonicalizer paramCharsToNameCanonicalizer) {
    ...
    boolean bool2 = JsonParser.Feature.CANONICALIZE_FIELD_NAMES.enabledIn(paramInt);
    boolean bool1 = JsonParser.Feature.INTERN_FIELD_NAMES.enabledIn(paramInt);
    if (jsonEncoding == JsonEncoding.UTF8 && bool2) {
      paramBytesToNameCanonicalizer = paramBytesToNameCanonicalizer.makeChild(bool2, bool1);
    ...
    return new ReaderBasedParser(this._context, paramInt, constructReader(), paramObjectCodec, paramCharsToNameCanonicalizer.makeChild(bool2, bool1));
  }
...
/* Location:              C:\Users\walle\Downloads\boomlings-1-20 (2)\boomlings-1-20-dex2jar.jar!\com\flurry\org\codehaus\jackson\impl\ByteSourceBootstrapper.class
