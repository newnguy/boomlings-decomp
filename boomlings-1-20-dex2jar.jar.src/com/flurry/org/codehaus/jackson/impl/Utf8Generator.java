...
public class Utf8Generator extends JsonGeneratorBase {
  ...
  private int _handleLongCustomEscape(byte[] paramArrayOfbyte1, int paramInt1, int paramInt2, byte[] paramArrayOfbyte2, int paramInt3) {
    ...
    if (paramInt1 + j > paramInt2) {
      ...
      System.arraycopy(paramArrayOfbyte2, 0, paramArrayOfbyte1, k, j);
      paramInt1 = k + j;
    } 
    int i = paramInt1;
  ...
  private final int _outputMultiByteChar(int paramInt1, int paramInt2) {
    ...
    int i = j + 1;
    arrayOfByte[j] = (byte)(paramInt1 >> 6 & 0x3F | 0x80);
    paramInt2 = i + 1;
    arrayOfByte[i] = (byte)(paramInt1 & 0x3F | 0x80);
    return paramInt2;
  }
  ...
  private final void _writeCustomStringSegment2(char[] paramArrayOfchar, int paramInt1, int paramInt2) {
    ...
    while (i < paramInt2) {
      ...
      if (i <= 127) {
        ...
        if (m == -2) {
          SerializableString serializableString1 = characterEscapes.getEscapeSequence(i);
      ...
      SerializableString serializableString = characterEscapes.getEscapeSequence(i);
...
/* Location:              C:\Users\walle\Downloads\boomlings-1-20 (2)\boomlings-1-20-dex2jar.jar!\com\flurry\org\codehaus\jackson\impl\Utf8Generator.class
