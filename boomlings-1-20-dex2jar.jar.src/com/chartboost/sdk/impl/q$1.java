...
class q$1 extends DataSetObserver {
  ...
  public void onChanged() {
    ...
    for (byte b = 0;; b++) {
      ...
      List list1 = q.b(this.a).get(((Integer)q.c(this.a).get(b)).intValue());
      List<View> list = q.d(this.a).get(((Integer)q.c(this.a).get(b)).intValue());
...
/* Location:              C:\Users\walle\Downloads\boomlings-1-20 (2)\boomlings-1-20-dex2jar.jar!\com\chartboost\sdk\impl\q$1.class
